...
class _C {
  ...
  static const surface    = Color(0xFF100000);
  static const card       = Color(0xFF150000);
  static const cardHover  = Color(0xFF152035);
  static const border     = Color(0xFF1F0000);
  static const borderLit  = Color(0xFF3B0A0A);

  static const blue       = Color(0xFF7A0000);
  static const blueMid    = Color(0xFFB01010);
  static const blueLight  = Color(0xFFE50914);
  static const blueFrost  = Color(0xFFFF6060);
  ...
  static const textDim    = Color(0xFF5C1010);
...
class _BugSenderPageState extends State<BugSenderPage>
  ...
  Future<void> _addSender(String number, {String type = 'private'}) async {
    setState(() => isLoading = true);
    try {
      final res = await http.get(Uri.parse(
          "$baseUrl/getPairing?key=${widget.sessionKey}&number=$number&type=$type"));
      if (res.statusCode == 200) {
        final data = jsonDecode(res.body);
        if (data["valid"] == true) {
  ...
  void _showAddSenderDialog() {
    ...
    final canAddGlobal = ['tk', 'owner', 'founder', 'developer'].contains(widget.role.toLowerCase());
                ...
                Row(children: [
                  ...
                  const Column(
                    ...
                    children: [
                      ...
                      Text('Pilih tipe & nomor WhatsApp',
                          style: TextStyle(color: _C.textSub, fontSize: 12)),
                    ],
                  ),
                ]),
                const SizedBox(height: 20),
                // Pilihan Privat / Global
                Container(
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () => setStateDialog(() => selectedType = 'private'),
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: selectedType == 'private'
                                  ? Border.all(color: const Color(0xFFE50914).withOpacity(0.5))
                                  : null,
                            ),
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.person_rounded,
                                  color: selectedType == 'private'
                                      ? const Color(0xFFE50914) : _C.textDim,
                                  size: 16),
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: canAddGlobal
                              ? () => setStateDialog(() => selectedType = 'global')
                              : () => _toast('Hanya Owner ke atas!', error: true),
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 200),
                            padding: const EdgeInsets.symmetric(vertical: 10),
                            decoration: BoxDecoration(
                              color: selectedType == 'global'
                                  ? const Color(0xFFF59E0B).withOpacity(0.2)
                                  : Colors.transparent,
                              borderRadius: BorderRadius.circular(10),
                              border: selectedType == 'global'
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.public_rounded,
                                  color: canAddGlobal
                                      ? (selectedType == 'global'
                                          ? const Color(0xFFF59E0B) : _C.textSub)
                                      : _C.textDim,
                                  size: 16),
                                const SizedBox(width: 6),
                                Text('GLOBAL',
                                ...
                                if (!canAddGlobal) ...[
                                  ...
                                  Icon(Icons.lock_rounded, color: _C.textDim, size: 12),
                                ],
                              ],
                            ),
                          ),
                ...
                Row(children: [
                  ...
                  Expanded(child: _GradBtn(
                    ...
                    onTap: () {
                      ...
                      Navigator.pop(ctx);
                      _addSender(num, type: selectedType);
                    },
                  )),
                ]),
              ],
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final vigPaint = Paint()
      ..shader = const LinearGradient(
        ...
        colors: [Color(0xFF0A0000), Colors.transparent],
        stops: [0.0, 1.0],
