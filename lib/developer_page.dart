// developer_page.dart - DEVELOPER PAGE (FULLY FIXED)
// NEON GLOW THEME - MODERN DARK STYLE
// DURASI DROPDOWN - FIXED
...
class DeveloperPage extends StatefulWidget {
  ...
  const DeveloperPage({super.key, required this.sessionKey});
...
class _DeveloperPageState extends State<DeveloperPage>
  ...
  final List<String> roleOptions = ['member', 'reseller', 'vip', 'tk', 'owner', 'founder', 'developer'];
  String selectedRole = 'member';

  // ⬇️ DURASI DROPDOWN OPTIONS
  ...
  String selectedDuration = '7 Hari';
  ...
  // ⬇️ createDayController DIHAPUS - GANTI DROPDOWN
  ...
  void dispose() {
    ...
    // ⬇️ createDayController DISPOSE DIHAPUS
    super.dispose();
  }
  ...
  // ⬇️ FUNGSI KONVERSI DURASI KE HARI
  ...
  Future<void> _createAccount() async {
    ...
    // ⬇️ AMBIL DARI DROPDOWN, BUKAN TEXTFIELD
    int day = _convertDurationToDays(selectedDuration);

    if (username.isEmpty || password.isEmpty) {
      _alert('Perhatian', 'Username dan Password wajib diisi.', isError: true);
      return;
    }
    setState(() => isLoading = true);
    try {
      ...
      if (data['created'] == true) {
        ...
        setState(() {
          newUserRole = 'member';
          selectedDuration = '7 Hari';  // ⬅️ RESET KE DEFAULT
        });
        _fetchUsers();
      } else {
      ...
      pageBuilder: (ctx, _, __) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: (isError ? neonPink : neonCyan)
                    .withOpacity(0.15),
                blurRadius: 40,
                spreadRadius: 0,
              ),
      ...
      pageBuilder: (ctx, _, __) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border:
                Border.all(color: neonPink.withOpacity(0.35), width: 1.5),
            boxShadow: [
              BoxShadow(
  ...
  Widget _buildButton({
    ...
    final Color baseColor = isDestructive ? neonPink : neonCyan;
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          floatingLabelStyle:
              const TextStyle(color: neonCyan, fontSize: 12),
          prefixIcon:
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: options.map((opt) {
                final color = opt == 'owner' ? neonPink :
                              opt == 'developer' ? neonCyan :
                              opt == 'founder' ? neonPurple :
                              opt == 'tk' ? const Color(0xFFFF6D00) :
                              opt == 'reseller' ? const Color(0xFF22C55E) :
                              opt == 'vip' ? const Color(0xFFB026FF) :
                              Colors.white70;
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: durationOptions.map((opt) {
                final isPermanent = opt == 'Permanent';
                return DropdownMenuItem(
                  value: opt,
                  child: Row(
                    children: [
                      ...
                      Text(
                        opt,
                        style: TextStyle(
                          color: isPermanent ? neonPink : textPrimary,
                          fontWeight: isPermanent ? FontWeight.w700 : FontWeight.w400,
                        ),
                      ),
                      if (isPermanent) ...[
                        const Spacer(),
  ...
  Widget _buildUserItem(Map user, int index) {
    final roleColor = user['role'] == 'owner' ? neonPink :
                      user['role'] == 'developer' ? neonCyan :
                      user['role'] == 'founder' ? neonPurple :
                      user['role'] == 'tk' ? const Color(0xFFFF6D00) :
                      user['role'] == 'reseller' ? const Color(0xFF22C55E) :
                      user['role'] == 'vip' ? const Color(0xFFB026FF) :
                      Colors.white70;
                    ...
                    delegate: SliverChildListDelegate([
                      ...
                      _buildSection(
                        ...
                        children: [
                          ...
                          // ⬇️ GANTI: DROPDOWN DURASI (BUKAN TEXTFIELD)
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                    color: neonCyan.withOpacity(0.4 * _pulse.value)),
                boxShadow: [
                  BoxShadow(
                    color: neonCyan.withOpacity(0.2 * _pulse.value),
                    blurRadius: 16,
                  ),
                ],
              ),
  ...
  Widget _buildStatsRow() {
    ...
    final totalReseller =
        fullUserList.where((u) => ['reseller','vip','owner','tk','founder','developer'].contains(u['role'])).length;
    final totalMember =
    ...
    return Row(
      children: [
        _buildStatCard('Total User', '$totalAll',
            Icons.people_outline_rounded, neonCyan),
        const SizedBox(width: 10),
        _buildStatCard('Premium', '$totalReseller',
            Icons.storefront_outlined, neonPurple),
        const SizedBox(width: 10),
        _buildStatCard('Member', '$totalMember',
            Icons.person_outline_rounded, textMuted),
      ],
    );
  }
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _pressed
              ...
              : _DeveloperPageState.bgSurface,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: _DeveloperPageState.borderColor),
        ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: widget.active
              ? _DeveloperPageState.neonCyan
              : (_pressed ? _DeveloperPageState.borderColor : _DeveloperPageState.bgSurface),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: widget.active
                ? _DeveloperPageState.neonCyan
                : _DeveloperPageState.borderColor,
          ),
          boxShadow: widget.active
              ? [
                  BoxShadow(
                    color: _DeveloperPageState.neonCyan.withOpacity(0.3),
                    blurRadius: 8,
                  )
                ]
              : null,
          ...
          child: widget.icon != null
              ? Icon(widget.icon,
                  ...
                  color: widget.enabled
                      ? _DeveloperPageState.textMuted
                      : _DeveloperPageState.borderColor)
              : Text(
                  widget.label ?? '',
                  style: TextStyle(
                    color: widget.active
                        ? _DeveloperPageState.textPrimary
                        : _DeveloperPageState.textMuted,
                    fontSize: 13,
            ...
            return Padding(
              ...
              child: Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: _DeveloperPageState.neonCyan
