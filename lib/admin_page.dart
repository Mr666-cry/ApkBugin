// admin_page.dart - DURASI DENGAN PILIHAN DROPDOWN
// ✅ FIXED: Duration dropdown (1 Hari, 3 Hari, 7 Hari, 1 Bulan, Permanent)
...
class _AdminPageState extends State<AdminPage>
  ...
  final List<String> roleOptions = ['member', 'reseller', 'vip'];
  ...
  static const Color primary     = Color(0xFF7A0000);
  ...
  Widget _buildStatsRow() {
    ...
    final totalReseller =
        fullUserList.where((u) => ['reseller','vip','owner','high_owner','founder','developer'].contains(u['role'])).length;
    final totalMember =
        fullUserList.where((u) => u['role'] == 'full_up').length;
