// creator_page.dart - FULLY FIXED VERSION
// ✅ DURASI DROPDOWN (1 Hari, 3 Hari, 7 Hari, 1 Bulan, Permanent)
// ✅ FIX: Icons.infinity_rounded → Text "∞"
...
class CreatorPage extends StatefulWidget {
  ...
  const CreatorPage({super.key, required this.sessionKey});
...
class _CreatorPageState extends State<CreatorPage>
  ...
  final List<String> roleOptions = ['member', 'reseller', 'vip', 'tk', 'owner'];
  ...
  static const Color primary     = Color(0xFF1A5A8C);
  ...
  Future<void> _createAccount() async {
    ...
    // ✅ AMBIL NILAI DARI DROPDOWN DURASI
    final day = selectedDuration;
  ...
  // ✅ DROPDOWN DURASI - FIXED (PAKAI TEXT "∞")
          ...
          children: [
            ...
            DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                icon: const Icon(Icons.expand_more, color: textSub, size: 20),
                style: const TextStyle(
                  color: textPrimary,
                  fontSize: 14,
                ...
                items: durationOptions.map((opt) {
                  return DropdownMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        // ✅ FIX: PAKAI TEXT "∞" UNTUK PERMANENT
                        if (opt['value'] == '0')
                          Container(
                            width: 20,
                            height: 20,
  ...
  Widget _buildStatsRow() {
    ...
    final totalReseller =
        fullUserList.where((u) => ['reseller','vip','owner','tk'].contains(u['role'])).length;
    final totalMember =
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _pressed
              ...
              : _CreatorPageState.bgSurface,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: _CreatorPageState.borderColor),
        ),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: widget.active
              ? _CreatorPageState.primaryLit
              : (_pressed ? _CreatorPageState.borderColor : _CreatorPageState.bgSurface),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: widget.active
                ? _CreatorPageState.primaryLit
                : _CreatorPageState.borderColor,
          ),
          boxShadow: widget.active
              ? [
                  BoxShadow(
                    color: _CreatorPageState.primaryLit.withOpacity(0.3),
                    blurRadius: 8,
                  )
                ]
              : null,
          ...
          child: widget.icon != null
              ? Icon(widget.icon,
                  ...
                  color: widget.enabled
                      ? _CreatorPageState.textMuted
                      : _CreatorPageState.borderColor)
              : Text(
                  widget.label ?? '',
                  style: TextStyle(
                    color: widget.active
                        ? _CreatorPageState.textPrimary
                        : _CreatorPageState.textMuted,
                    fontSize: 13,
            ...
            return Padding(
              ...
              child: Transform.scale(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: _CreatorPageState.primaryLit
